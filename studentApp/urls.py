...
urlpatterns = [
    ...
    path('my-hostel/', student_my_hostel, name='student_my_hostel'),
    ...
    path('school-timetable/', student_school_timetable, name='student_school_timetable'),
    path('school-timetable/pdf/', student_school_timetable_pdf, name='student_school_timetable_pdf'),
