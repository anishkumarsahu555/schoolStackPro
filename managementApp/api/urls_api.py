...
#     path('get_subjects_list_api', get_subjects_list_api, name='get_subjects_list_api'),
    ...
    path('get_finance_account_options_api', get_finance_account_options_api, name='get_finance_account_options_api'),
    path('get_finance_settings_api', get_finance_settings_api, name='get_finance_settings_api'),
    path('upsert_finance_settings_api', upsert_finance_settings_api, name='upsert_finance_settings_api'),
    path('get_finance_payment_mode_options_api', get_finance_payment_mode_options_api, name='get_finance_payment_mode_options_api'),
    path('get_vendor_list_api', get_vendor_list_api, name='get_vendor_list_api'),
    path('search_vendor_suggestions_api', search_vendor_suggestions_api, name='search_vendor_suggestions_api'),
    path('FinanceVendorListJson', FinanceVendorListJson.as_view(), name='FinanceVendorListJson'),
    path('upsert_vendor_api', upsert_vendor_api, name='upsert_vendor_api'),
    path('delete_vendor_api', delete_vendor_api, name='delete_vendor_api'),
    path('get_vendor_payables_api', get_vendor_payables_api, name='get_vendor_payables_api'),
    path('finance_vendor_payables_rows_api', finance_vendor_payables_rows_api, name='finance_vendor_payables_rows_api'),
    path('finance_vendor_outstanding_voucher_rows_api', finance_vendor_outstanding_voucher_rows_api, name='finance_vendor_outstanding_voucher_rows_api'),
    path('get_vendor_statement_api', get_vendor_statement_api, name='get_vendor_statement_api'),
    path('finance_vendor_statement_rows_api', finance_vendor_statement_rows_api, name='finance_vendor_statement_rows_api'),
    path('get_receipt_charge_options_api', get_receipt_charge_options_api, name='get_receipt_charge_options_api'),
    path('get_receipt_refund_options_api', get_receipt_refund_options_api, name='get_receipt_refund_options_api'),
    path('FinanceFeeHeadListJson', FinanceFeeHeadListJson.as_view(), name='FinanceFeeHeadListJson'),
    path('FinanceReceiptListJson', FinanceReceiptListJson.as_view(), name='FinanceReceiptListJson'),
    path('FinanceStudentChargeListJson', FinanceStudentChargeListJson.as_view(), name='FinanceStudentChargeListJson'),
    path('FinanceExpenseCategoryListJson', FinanceExpenseCategoryListJson.as_view(), name='FinanceExpenseCategoryListJson'),
    path('FinanceExpenseVoucherListJson', FinanceExpenseVoucherListJson.as_view(), name='FinanceExpenseVoucherListJson'),
    path('get_payment_receipt_list_api', get_payment_receipt_list_api, name='get_payment_receipt_list_api'),
    path('get_finance_reports_api', get_finance_reports_api, name='get_finance_reports_api'),
    path('get_finance_control_center_api', get_finance_control_center_api, name='get_finance_control_center_api'),
    path('upsert_finance_approval_rule_api', upsert_finance_approval_rule_api, name='upsert_finance_approval_rule_api'),
    path('delete_finance_approval_rule_api', delete_finance_approval_rule_api, name='delete_finance_approval_rule_api'),
    path('get_finance_audit_trail_api', get_finance_audit_trail_api, name='get_finance_audit_trail_api'),
    path('FinanceAuditTrailListJson', FinanceAuditTrailListJson.as_view(), name='FinanceAuditTrailListJson'),
    path('get_finance_reconciliation_api', get_finance_reconciliation_api, name='get_finance_reconciliation_api'),
    path('finance_recon_receipt_rows_api', finance_recon_receipt_rows_api, name='finance_recon_receipt_rows_api'),
    path('finance_recon_charge_rows_api', finance_recon_charge_rows_api, name='finance_recon_charge_rows_api'),
    path('finance_recon_voucher_rows_api', finance_recon_voucher_rows_api, name='finance_recon_voucher_rows_api'),
    path('finance_recon_payroll_rows_api', finance_recon_payroll_rows_api, name='finance_recon_payroll_rows_api'),
    path('get_receipt_adjustment_history_api', get_receipt_adjustment_history_api, name='get_receipt_adjustment_history_api'),
    path('get_payroll_run_list_api', get_payroll_run_list_api, name='get_payroll_run_list_api'),
    path('get_payroll_run_detail_api', get_payroll_run_detail_api, name='get_payroll_run_detail_api'),
    path('create_manual_payment_receipt_api', create_manual_payment_receipt_api, name='create_manual_payment_receipt_api'),
    path('create_payment_refund_api', create_payment_refund_api, name='create_payment_refund_api'),
    path('upsert_finance_period_api', upsert_finance_period_api, name='upsert_finance_period_api'),
    path('repair_finance_reconciliation_issue_api', repair_finance_reconciliation_issue_api, name='repair_finance_reconciliation_issue_api'),
    path('create_payroll_run_api', create_payroll_run_api, name='create_payroll_run_api'),
    path('approve_expense_voucher_api', approve_expense_voucher_api, name='approve_expense_voucher_api'),
    path('approve_payment_receipt_api', approve_payment_receipt_api, name='approve_payment_receipt_api'),
    path('approve_payment_refund_api', approve_payment_refund_api, name='approve_payment_refund_api'),
    path('approve_payroll_run_api', approve_payroll_run_api, name='approve_payroll_run_api'),
    path('approve_payroll_payment_api', approve_payroll_payment_api, name='approve_payroll_payment_api'),
    path('post_payroll_run_api', post_payroll_run_api, name='post_payroll_run_api'),
    path('pay_payroll_line_api', pay_payroll_line_api, name='pay_payroll_line_api'),
    path('reverse_payment_receipt_api', reverse_payment_receipt_api, name='reverse_payment_receipt_api'),
    path('get_student_charge_list_api', get_student_charge_list_api, name='get_student_charge_list_api'),
    path('get_fee_head_list_api', get_fee_head_list_api, name='get_fee_head_list_api'),
    path('upsert_fee_head_api', upsert_fee_head_api, name='upsert_fee_head_api'),
    path('delete_fee_head_api', delete_fee_head_api, name='delete_fee_head_api'),
    path('get_student_finance_ledger_api', get_student_finance_ledger_api, name='get_student_finance_ledger_api'),
    path('finance_student_ledger_rows_api', finance_student_ledger_rows_api, name='finance_student_ledger_rows_api'),
    path('get_expense_category_list_api', get_expense_category_list_api, name='get_expense_category_list_api'),
    path('upsert_expense_category_api', upsert_expense_category_api, name='upsert_expense_category_api'),
    path('delete_expense_category_api', delete_expense_category_api, name='delete_expense_category_api'),
    path('get_expense_voucher_list_api', get_expense_voucher_list_api, name='get_expense_voucher_list_api'),
    path('upsert_expense_voucher_api', upsert_expense_voucher_api, name='upsert_expense_voucher_api'),
    path('delete_expense_voucher_api', delete_expense_voucher_api, name='delete_expense_voucher_api'),
    path('get_cash_bank_book_api', get_cash_bank_book_api, name='get_cash_bank_book_api'),
    path('finance_cash_bank_book_rows_api', finance_cash_bank_book_rows_api, name='finance_cash_bank_book_rows_api'),
