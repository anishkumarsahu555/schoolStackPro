...
urlpatterns = [
    ...
    path('school-timetable/', teacher_school_timetable, name='teacher_school_timetable'),
    path('school-timetable/pdf/', teacher_school_timetable_pdf, name='teacher_school_timetable_pdf'),
    ...
    path('holidays/', teacher_holiday_list, name='teacher_holiday_list'),
